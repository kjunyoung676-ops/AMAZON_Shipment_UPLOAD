...
const MASTER_INIT: Record<string, MasterItem> = {
  ...
  "HS904018-5W":      {sku:"US-HS8W86-090-040-180-5S-1Pack", asin:"B09NLJMGDZ", to:"H2",  loc:"J-09-W", cpp:16, fba:1100, price:16400, kg:22.00, bx:94.5, by:41.5, bz:12.5},
  ...
  "HS904016.5W-5B":   {sku:"HS904016.5W-5B-JP",              asin:"B0CTKDFQ47", to:"H5",  loc:"J-13-B", cpp:16, fba:1532, price:18800, kg:27.20, bx:42,   by:96,   bz:13  },
